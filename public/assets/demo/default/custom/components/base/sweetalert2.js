var SweetAlert2Demo = {
    init: function() {
        ...
        $(document).on('click', '.cancelalert', function(t) {
            t.preventDefault();
            var deleteurl = $(this).attr('href');
        ...
        $(document).on('click', '.cancelreqalert', function(t) {
            t.preventDefault();
            var deleteurl = $(this).attr('href');

            swal({
                title: "Are you sure you want to cancel your request?",
                text: "Once it cancelled, you need to make new request to join facility/physician.",
                type: "success",
                showCancelButton: !0,
                confirmButtonText: "Yes",
                cancelButtonText: "No",
        ...
        $(document).on('click', '.acceptreqalert', function(t) {
            t.preventDefault();
            var deleteurl = $(this).attr('href');

            swal({
                title: "Are you sure you want to accept request?",
                text: "Once it accepted, you can't change facility/physician.",
                type: "success",
                showCancelButton: !0,
                confirmButtonText: "Yes",
                cancelButtonText: "No",
